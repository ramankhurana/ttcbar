...
parser.add_argument("-p", "--processes", dest="process_attributes", default="process_attributes.py")
parser.add_argument("-v", "--variables", dest="plot_attributes", default="plot_attributes.py")
